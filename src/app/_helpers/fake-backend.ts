...
export class FakeBackendInterceptor implements HttpInterceptor {
  intercept(
    ...
    // envelopper dans l'observable retardé pour simuler l'appel de l'api du serveur
    return of(null)
      .pipe(mergeMap(handleRoute))
      .pipe(materialize()) // appelez matérialiser et dématérialiser pour garantir un délai même si une erreur est générée (https://github.com/Reactive-Extensions/RxJS/issues/648)
      .pipe(delay(500))
      .pipe(dematerialize());
